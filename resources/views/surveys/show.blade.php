            ...
            <div class="border border-gray-200 w-1/2 rounded-md p-4">
                <div class="grid grid-cols-2 grid-rows-3 grid-flow-col gap-4">
                    <div class="flex flex-col items-start">
                        <label for="name" class="text-sm">{{ __('surveys/show.survey_data.survey_name') }}</label>
                        <span id="name" class="text-xs mt-1">{{ $survey->name }}</span>
                    </div>
                    <div class="flex flex-col items-start">
                        <label for="description"
                            class="text-sm">{{ __('surveys/show.survey_data.survey_description') }}</label>
                        <span id="description" class="text-xs mt-1">{{ $survey->description }}</span>
                    </div>
                    <div class="flex flex-col items-start">
                        <label for="status" class="text-sm">{{ __('surveys/show.survey_data.survey_status') }}</label>
                        <span id="status"
                    ...
                    <div class="flex flex-col items-start">
                        <label for="is-template"
                            class="text-sm">{{ __('surveys/show.survey_data.survey_template') }}</label>
                        <span id="is-template"
                            class="text-xs mt-1">{{ ucfirst($survey->is_template ? 'Yes' : 'No') }}</span>
                    </div>
                    <div class="flex flex-col items-start">
                        <label for="contains-excel"
                            class="text-sm">{{ __('surveys/show.survey_data.survey_excel_import') }}</label>
